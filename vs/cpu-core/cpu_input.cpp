...
bool cpu_input::IsSpace()
{
	return vi.IsKey(VK_SPACE) || xi.IsButton(0);
}

bool cpu_input::IsSpacePressed()
{
	return vi.IsKeyPressed(VK_SPACE) || xi.IsButtonPressed(0);
}

bool cpu_input::IsSpaceReleased()
{
	return vi.IsKeyReleased(VK_SPACE) || xi.IsButtonReleased(0);
}
